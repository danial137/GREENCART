...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-14 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (<button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary transition text-white rounded-full">
                    ...
                    :
                    (
                        <div onClick={() => navigate("/cart")} className='relative group'>
