...
const ProductCard = ({ product }) => {
    ...
    return product && (
        <div onClick={() => { navigate(`/products/${product.category.toLowerCase()}/${product._id}`); scrollTo(0, 0) }} className="border border-gray-500/20 rounded-md px-3 py-2 bg-white w-full max-w-full">
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                        ...
                        <img key={i} src={1 < 4 ? assets.star_icon : assets.star_dull_icon} alt='' />
